type MiddlewareWrapper<Middleware> = (wrappedMiddleware: Middleware) => Middleware
...
export const compose = <Middleware>(
  ...
  otherMiddlewareWrappers.reduce(
    (accumulatedMiddlewares, nextMiddleware) => (middleware) => accumulatedMiddlewares(nextMiddleware(middleware)),
